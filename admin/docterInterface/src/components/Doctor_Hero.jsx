...
export default function DoctorHeroPart() {
  return (
    <div 
    ...
    >
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-center text-base/7 font-semibold text-amber-950">Manage Your Appointments</h2>
        <p className="mx-auto mt-2 max-w-lg text-center text-4xl font-semibold tracking-tight text-amber-950 sm:text-5xl">
          Set Your Availability and View Appointments
        </p>
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-amber-950 max-lg:text-center">
                  Easily create time slots for pet consultations, and allow clients to book appointments with you.
                </p>
              </div>
          ...
          <div className="relative max-lg:row-start-1">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-amber-950 max-lg:text-center">View Appointments</p>
                <p className="mt-2 max-w-lg text-sm/6 text-amber-950 max-lg:text-center">
                  View upcoming pet appointments and manage your schedule seamlessly.
                </p>
              </div>
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-amber-950 max-lg:text-center">
                  Receive automatic reminders for scheduled appointments with pets to avoid any missed consultations.
                </p>
              </div>
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-amber-950 max-lg:text-center">
                  Access pet patient history and previous consultation records to provide better care.
                </p>
              </div>
