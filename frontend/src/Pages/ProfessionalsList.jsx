...
const ProfessionalsList = () => {
  ...
  useEffect(() => {
    ...
    if (roleFilter !== 'All') {
      filtered = filtered.filter((professional) => professional.role === roleFilter);
    }
    ...
    if (searchQuery) {
      filtered = filtered.filter(
        (professional) =>
          ...
          professional.professionalEmail.toLowerCase().includes(searchQuery.toLowerCase())
      );
    }
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-amber-700 text-white">
                ...
                <th className="p-3 text-sm font-semibold">Update</th>
                <th className="p-3 text-sm font-semibold">Delete</th>
              </tr>
            </thead>
            <tbody>
              {filteredProfessionals.length === 0 ? (
                ...
                filteredProfessionals.map((professional) => (
                  <tr key={professional._id} className="border-b border-amber-200">
                    ...
                    <td className="p-3">
                      <button
                        ...
                        aria-label={`Update professional ${professional.name}`}
                      >
                    ...
                    <td className="p-3">
                      <button
                        ...
                        aria-label={`Delete professional ${professional.name}`}
                      >
