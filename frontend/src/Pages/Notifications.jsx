        ...
        {notifications.length === 0 ? (
          ...
          <div className="space-y-8">
            {adminNotifications.length > 0 && (
              <div>
                <h2 className="text-xl font-semibold text-amber-900 mb-4 border-b border-amber-200 pb-2">Admin Notifications</h2>
                {adminNotifications.map((notification) => (
                  <div
                    key={notification._id}
                    className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                    <div className="md:flex">
                      <div className="md:flex-shrink-0 bg-gradient-to-b from-[#D08860] to-[#B3704D] flex items-center justify-center w-28 h-28 md:h-auto">
                      ...
                      <div className="p-6 md:flex-1 flex justify-between items-center">
                        <div>
                          ...
                          <p className={`text-gray-600 text-base ${notification.read ? "text-gray-500" : "font-medium"}`}>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <Link
                            ...
                            className="flex items-center bg-gradient-to-r from-[#D08860] to-[#B3704D] text-white px-3 py-1 rounded hover:bg-[#80533b] transition-colors text-sm font-medium"
                          >
