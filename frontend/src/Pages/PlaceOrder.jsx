...
const navigate = useNavigate();
  ...
  return (
    <div className='flex flex-col sm:flex-row	justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t mt-10 mr-20 ml-10 mb-10' >
      <div className='flex flex-col gap-4 w-full sm;max-w-[480px]'>

        <div className='text-xl sm:text-2xl my-3'>
              <MarketplaceTitle text1={'DELIVERY'} text2={'INFORMATION'} />
        </div>
        ...
        <div className='mt-8 '>
          ...
          <div className='mt-12'>
              <MarketplaceTitle text1={'PAYMENT'} text2={'METHOD'} />
              <div className='flex gap-3 flex-col lg:flex-row'>
                ...
                <div onClick={()=>setMethod('razorpay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                  ...
                  <img className='h-5 mx-4' src={assets.razorpay_logo} alt="Razor" />
                </div>
