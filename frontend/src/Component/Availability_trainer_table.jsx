    ...
    const fetchAvailabilities = async () => {
      try {
        ...
        const response = await axios.get(
          "http://localhost:5000/api/appointments/pet-trainer-Reqappointments",
          { timeout: 5000 }
        );
          ...
          <table className="min-w-full table-auto">
            <thead className="bg-amber-950 text-white">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-medium uppercase tracking-wider">Qualification</th>
              ...
              {filteredAvailabilities.length === 0 ? (
                ...
                filteredAvailabilities.map((availability, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">{availability.specialization || "N/A"}</td>
