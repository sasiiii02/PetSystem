...
import { Search, XCircle } from 'lucide-react'; // Added XCircle icon for cancelled appointments
...
const AppointmentAllCancelledTable = () => {
  ...
  const handleDelete = (appointment) => {
    console.log('Delete clicked for:', appointment);
    alert(`Deleting appointment data`);
  };
          ...
          <table className="min-w-full table-auto">
            <thead className="bg-amber-950 text-white">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-medium uppercase tracking-wider">Doctor ID</th>
                ...
                filteredAppointments.map((appointment, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span
                        className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800"
                      >
                        {appointment.status}
                      </span>
                    </td>
