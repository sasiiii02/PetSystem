...
const PetPlatformHomePage = () => {
  ...
  const openGuide = () => {
    setShowGuide(true);
    setCurrentStep(0);
    // Add body class to prevent scrolling while guide is open
      ...
      >
        <div className="text-center max-w-4xl px-6">
          ...
          <div className="flex justify-center space-x-6">
            <button 
              className="bg-[#D08860] text-white text-lg px-10 py-4 rounded-full hover:bg-[#B3714E] transition-colors duration-300 flex items-center shadow-lg hover:shadow-xl"
              onClick={openGuide}
            >
          ...
          <div className="bg-white rounded-3xl w-full max-w-3xl overflow-hidden shadow-2xl animate-fadeIn">
            ...
            <div className="flex justify-center gap-2 pt-6">
              {guideSteps.map((_, index) => (
                <div 
                  key={index} 
                  className={`h-2 rounded-full transition-all duration-300 ${currentStep === index ? 'w-8 bg-[#D08860]' : 'w-3 bg-gray-300'}`}
                />
              ))}
            </div>
            ...
            <div className="p-12 pt-8">
              <div className={`flex justify-center mb-8 p-6 rounded-full w-32 h-32 mx-auto ${guideSteps[currentStep].color}`}>
              ...
              <div className="flex justify-between items-center">
                ...
                <button 
                  onClick={nextStep}
                  className="bg-[#D08860] text-white text-lg px-8 py-3 rounded-full hover:bg-[#B3714E] transition-colors duration-300 flex items-center shadow-md"
                >
